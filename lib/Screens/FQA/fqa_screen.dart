    ...
    return BlocConsumer<MainCubit,MainStates>(
      ...
      MainCubit  cubit = MainCubit.get(context);
        ...
        return Scaffold(
          ...
          body: state is FaqLoadingStates? Center(child: CircularProgressIndicator(),):
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child:Text('FAQ',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),

                ),
                ListView.separated(
                  physics: NeverScrollableScrollPhysics(),
                  shrinkWrap: true,
                  itemBuilder: (context, index)=> buildFQA(MainCubit.get(context).faqModel.data.data[index], context),
